  ...
  <StaticQuery
    ...
    render={(data) => (
      <div className="bg-washed-red flex flex-column justify-center items-center pa2 pv5">
        ...
        <Link to="/about" className="mt3 db no-underline ph5 pv3 sans-serif near-white bg-dark-gray ttu tracked b hover-bg-mid-gray shadow-3">About Parvani Vida</Link>
